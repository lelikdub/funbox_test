...
``` sh
$ git clone https://github.com/lelikdub/FunBox-test-task/
$ cd project-name
$ npm install
```
...
В файле *.json* хранится вся информация о продукте а также переменные и статуст товара.
...
### Обработка данных http://mustache.github.io
Запускается при запуске компиляции. 
